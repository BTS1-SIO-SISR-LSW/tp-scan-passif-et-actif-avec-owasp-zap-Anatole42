...
Ce dépôt sert de **template repository** pour un TP de **cybersécurité applicative** en **BTS SIO option SISR**. Il permet de lancer :
...
Ce travail s'inscrit dans les compétences du **Bloc 6 du BTS SIO** :
